 ...
 */
public class FollowersUserListFragment extends UserListFragment {
    public static FollowersUserListFragment getNewInstance(String userName) {
        FollowersUserListFragment followingUserListFragment = new FollowersUserListFragment();
    ...
    public void populateUserList(final long maxId) {
        TwitterApplication.getRestClient().getFollowersList(new JsonHttpResponseHandler() {
